...
<h2><font color=red>Процент прохождения сведений в ФНС по объектам по протоколу от <?= $date ?> года номер <?= $number ?> за период с <?= $period_start ?> по <?= $period_stop ?> </font></h2>
