...
<div class="main">
    ...
    <table class="main">
        <thead class="main">
        <tr class="main">
            <th class="main">Статус исходящего ФЛК</th>
            <th class="main">Статус исправления исходящего ФЛК</th>
            ...
            <th class="main">Файл выгрузки исходящего ФЛК</th>
            <th class="main">Ошибка импорта в ФНС</th>
            <th class="main">Статус исправления ошибки импорта в ФНС</th>
        </tr>
        </thead>
        <?php
